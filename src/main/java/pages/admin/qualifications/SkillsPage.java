...
public class SkillsPage extends PredefinedActions{
	...
	public SkillsPage clickOnAddSkillBtn() {
		waitForvisibilityOfElement(propOperation.getValue("addSkillbtn"), WaitType.FASTWAIT);
		clickOnElement(propOperation.getValue("addSkillbtn"), false);
		return this;
	}
	...
	public void waitForVisibilityOfToastMessage() {
		waitForvisibilityOfElement(propOperation.getValue("successToastMessage"), WaitType.FASTWAIT);
	}
	...
	public void deleteSkill(String skillName) {
		...
		waitForvisibilityOfElement(propOperation.getValue("deleteSkillToastMessage"), WaitType.FASTWAIT);
	}
